...
#define LOW_PRECISION`),e}const CL={[Vl]:"SHADOWMAP_TYPE_PCF",[Hs]:"SHADOWMAP_TYPE_VSM"};function RL(t){return CL[t.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const PL={[oa]:"ENVMAP_TYPE_CUBE",[us]:"ENVMAP_TYPE_CUBE",[Ju]:"ENVMAP_TYPE_CUBE_UV"};function IL(t){return t.envMap===!1?"ENVMAP_TYPE_CUBE":PL[t.envMapMode]||"ENVMAP_TYPE_CUBE"}const LL={[us]:"ENVMAP_MODE_REFRACTION"};function DL(t){return t.envMap===!1?"ENVMAP_MODE_REFLECTION":LL[t.envMapMode]||"ENVMAP_MODE_REFLECTION"}const NL={[wy]:"ENVMAP_BLENDING_MULTIPLY",[wR]:"ENVMAP_BLENDING_MIX",[TR]:"ENVMAP_BLENDING_ADD"};function UL(t){return t.envMap===!1?"ENVMAP_BLENDING_NONE":NL[t.combine]||"ENVMAP_BLENDING_NONE"}function FL(t){const e=t.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),7*16)),texelHeight:i,maxMip:n}}function kL(t,e,n,i){const r=t.getContext(),a=n.defines;let s=n.vertexShader,o=n.fragmentShader;const l=RL(n),u=IL(n),c=DL(n),d=UL(n),f=FL(n),h=yL(n),m=SL(a),S=r.createProgram();let g,p,_=n.glslVersion?"#version "+n.glslVersion+`
